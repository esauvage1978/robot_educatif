...
|--------|-----------------|----------------|-------------------|-----------|
| **Prix** | **~200 €** | **~200 €** | **~400–450 €** | **~200 €** |
| **Âge** | **8–14 ans** | **6–10 ans** | **10–16 ans** | **9–15 ans** |
| **Niveau** | Intermédiaire | Débutant | Avancé | Intermédiaire |
| **Programmation** | Blocs + Arduino | Couleurs + Blockly / Scratch-like | Blocs + Arduino | Blocs + Python (selon usage) |
...
- [mBot Ranger Makeblock](https://www.amazon.fr/s?k=mBot+Ranger+Makeblock&tag=manuso06-21)
- [Ozobot Evo kit](https://www.amazon.fr/s?k=Ozobot+Evo+Entry+Kit&tag=manuso06-21)
- [mBot Ultimate Makeblock](https://www.amazon.fr/s?k=mBot+Ultimate+Makeblock&tag=manuso06-21)
